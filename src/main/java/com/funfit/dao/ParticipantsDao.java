...
public class ParticipantsDao {
	...
	PreparedStatement pstmt = con.prepareStatement("insert into participants(fname,age,phonenumber,emailid,bid) values(?,?,?,?,?);");
	pstmt.setString(1, participants.getFname());
	pstmt.setInt(2, participants.getAge());
	pstmt.setString(3, participants.getPhonenumber());
	pstmt.setString(4, participants.getEmailid());
